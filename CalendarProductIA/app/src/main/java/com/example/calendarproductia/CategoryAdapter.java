...
public class CategoryAdapter extends ArrayAdapter<CategoryItem> {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.categories_spinner, parent, false);
        }
        ImageView imageViewCategory = convertView.findViewById(R.id.category_image_view);
